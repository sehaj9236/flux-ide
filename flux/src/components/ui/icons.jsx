    ...
    <StyledWrapper>
      ...
      <ul className="example-2">
        <li className="icon-content">
          <a href="https://www.linkedin.com/in/sehaj-sharma-512a76323/" aria-label="LinkedIn" data-social="linkedin">
        ...
        <li className="icon-content">
          <a href="https://github.com/sehaj9236/flux" aria-label="GitHub" data-social="github">
            <div className="filled" />
